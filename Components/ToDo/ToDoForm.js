...
export default function ToDoForm(props) {
    ...
    const getCategories = () => {
        axios.get(`http://todoapi.brodishrout.com/api/categories`).then(response => setCategories(response.data))
    }
    ...
    const handleSubmit = (values) => {
        ...
        if (!props.todo) {
            ...
            axios.post(`http://todoapi.brodishrout.com/api/todo`, newToDo).then(() => {
                props.getToDo()
            ...
            axios.put(`http://todoapi.brodishrout.com/api/todo/${props.todo.toDoId}`, taskToEdit).then(() => {
                props.getToDo()
